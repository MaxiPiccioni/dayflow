...
import { ArrowDown, ArrowUp, ArrowUpDown, CalendarDays, Check, ChevronDown, ChevronLeft, ChevronRight, Clock3, Flame, LayoutDashboard, LogOut, Moon, MoreVertical, Pencil, Plus, Settings2, Sun, Timer, Trash2, Wallet, X } from "lucide-react";
...
const tabs = [["resumen", "Resumen", LayoutDashboard], ["calendario", "Calendario", CalendarDays], ["pomodoro", "Pomodoro", Timer], ["hábitos", "Hábitos", Flame], ["horas", "Horas", Clock3], ["finanzas", "Finanzas", Wallet]];
const WIDGET_META = [
