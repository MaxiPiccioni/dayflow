...
export function CardHeader({ title, eyebrow, action }) {
  return <div className="mb-5 flex items-start justify-between gap-4"><div><p className="text-xs font-semibold uppercase tracking-[0.18em] text-zinc-400">{eyebrow}</p><h2 className="mt-1 text-lg font-semibold text-zinc-950 dark:text-zinc-100">{title}</h2></div>{action}</div>;
}
